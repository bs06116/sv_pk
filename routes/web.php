...
// Route::view('addproperty', 'seller.addproperty')->name('addproperty');
        ...
        Route::get('/property-rent/{filter?}', function($filter = null){
            ...
            $filter="most-recent";
            return view('property.property-rent',compact('cities','filter'));})->name('property-rent'); 
...
//sale
        Route::get('/property-sale/{filter?}', function($filter = null){
            ...
            $filter="most-recent";
            return view('property.property-sale',compact('cities','filter'));})->name('property-sale');      
//land
            ...
            $filter="most-recent";
            return view('property.property-land',compact('cities','filter'));})->name('property-land'); 
...
//lease
            ...
            $filter="most-recent";
            return view('property.property-lease',compact('cities','filter'));})->name('property-lease'); 
       ...
       Route::get('/property-search-cits', 'SellerController@cits')->name('property-search-cits');
        ...
        //most popular places
         ...
         Route::get('/islamabad/{filter?}', function($filter = null){
            if (isset($filter) && $filter == 'lowest-price'){
                $cities=App\Models\Seller::where('city','=','Islamabad')->orderBy('price','asc')->get();
                return view('places.islamabad',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'highest-price'){
                $cities=App\Models\Seller::where('city','=','Islamabad')->orderBy('price','DESC')->get();
                return view('places.islamabad',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'most-recent'){
                $cities=App\Models\Seller::where('city','=','Islamabad')->orderBy('created_at','DESC')->get();
                return view('places.islamabad',compact('cities','filter'));
            }else{
                $cities=App\Models\Seller::where('city','=','Islamabad')->latest()->get();
            }
            $filter="most-recent";
            return view('places.islamabad',compact('cities','filter'));})->name('islamabad'); 
        ...
        // Route::view('/Bahawalpur', 'places.Bahawalpur')->name('Bahawalpur');
            ...
            if (isset($filter) && $filter == 'lowest-price'){
                $cities=App\Models\Seller::where('city','=','Bahawalpur')->orderBy('price','asc')->get();
                return view('places.Bahawalpur',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'highest-price'){
                $cities=App\Models\Seller::where('city','=','Bahawalpur')->orderBy('price','DESC')->get();
                return view('places.Bahawalpur',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'most-recent'){
                $cities=App\Models\Seller::where('city','=','Bahawalpur')->orderBy('created_at','DESC')->get();
                return view('places.Bahawalpur',compact('cities','filter'));
            }else{
                $cities=App\Models\Seller::where('city','=','Bahawalpur')->latest()->get();
            }
            $filter="most-recent";
            return view('places.Bahawalpur',compact('cities','filter'));})->name('Bahawalpur');        
        ...
        // Route::view('/Chakwal', 'places.Chakwal')->name('Chakwal');
            ...
            if (isset($filter) && $filter == 'lowest-price'){
                $cities=App\Models\Seller::where('city','=','Chakwal')->orderBy('price','asc')->get();
                return view('places.Chakwal',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'highest-price'){
                $cities=App\Models\Seller::where('city','=','Chakwal')->orderBy('price','DESC')->get();
                return view('places.Chakwal',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'most-recent'){
                $cities=App\Models\Seller::where('city','=','Chakwal')->orderBy('created_at','DESC')->get();
                return view('places.Chakwal',compact('cities','filter'));
            }else{
                $cities=App\Models\Seller::where('city','=','Chakwal')->latest()->get();
            }
            $filter="most-recent";
            return view('places.Chakwal',compact('cities','filter'));})->name('Chakwal');
        ...
        // Route::view('/Gawadar', 'places.Gawadar')->name('Gawadar');
            ...
            if (isset($filter) && $filter == 'lowest-price'){
                $cities=App\Models\Seller::where('city','=','Gawadar')->orderBy('price','asc')->get();
                return view('places.Gawadar',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'highest-price'){
                $cities=App\Models\Seller::where('city','=','Gawadar')->orderBy('price','DESC')->get();
                return view('places.Gawadar',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'most-recent'){
                $cities=App\Models\Seller::where('city','=','Gawadar')->orderBy('created_at','DESC')->get();
                return view('places.Gawadar',compact('cities','filter'));
            }else{
                $cities=App\Models\Seller::where('city','=','Gawadar')->latest()->get();
            }
            $filter="most-recent";
            return view('places.Gawadar',compact('cities','filter'));})->name('Gawadar');
        ...
        // Route::view('/Gujranwala', 'places.Gujranwala')->name('Gujranwala');
         ...
         Route::get('/Gujranwala/{filter?}', function($filter = null){
            if (isset($filter) && $filter == 'lowest-price'){
                $cities=App\Models\Seller::where('city','=','Gujranwala')->orderBy('price','asc')->get();
                return view('places.Gujranwala',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'highest-price'){
                $cities=App\Models\Seller::where('city','=','Gujranwala')->orderBy('price','DESC')->get();
                return view('places.Gujranwala',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'most-recent'){
                $cities=App\Models\Seller::where('city','=','Gujranwala')->orderBy('created_at','DESC')->get();
                return view('places.Gujranwala',compact('cities','filter'));
            }else{
                $cities=App\Models\Seller::where('city','=','Gujranwala')->latest()->get();
            }
            $filter="most-recent";
            return view('places.Gujranwala',compact('cities','filter'));})->name('Gujranwala');
        ...
        Route::get('/karachi/{filter?}', function($filter = null){
            if (isset($filter) && $filter == 'lowest-price'){
                $cities=App\Models\Seller::where('city','=','karachi')->orderBy('price','asc')->get();
                return view('places.karachi',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'highest-price'){
                $cities=App\Models\Seller::where('city','=','karachi')->orderBy('price','DESC')->get();
                return view('places.karachi',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'most-recent'){
                $cities=App\Models\Seller::where('city','=','karachi')->orderBy('created_at','DESC')->get();
                return view('places.karachi',compact('cities','filter'));
            }else{
                $cities=App\Models\Seller::where('city','=','karachi')->latest()->get();
            }
            $filter="most-recent";
            return view('places.karachi',compact('cities','filter'));})->name('karachi');
        ...
        Route::get('/lahore/{filter?}', function($filter = null){
            if (isset($filter) && $filter == 'lowest-price'){
                $cities=App\Models\Seller::where('city','=','lahore')->orderBy('price','asc')->get();
                return view('places.lahore',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'highest-price'){
                $cities=App\Models\Seller::where('city','=','lahore')->orderBy('price','DESC')->get();
                return view('places.lahore',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'most-recent'){
                $cities=App\Models\Seller::where('city','=','lahore')->orderBy('created_at','DESC')->get();
                return view('places.lahore',compact('cities','filter'));
            }else{
                $cities=App\Models\Seller::where('city','=','lahore')->latest()->get();
            }
            $filter="most-recent";
            return view('places.lahore',compact('cities','filter'));})->name('lahore');
        
        // Route::view('/Multan', 'places.Multan')->name('Multan');
        
        Route::get('/Multan/{filter?}', function($filter = null){
            if (isset($filter) && $filter == 'lowest-price'){
                $cities=App\Models\Seller::where('city','=','Multan')->orderBy('price','asc')->get();
                return view('places.Multan',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'highest-price'){
                $cities=App\Models\Seller::where('city','=','Multan')->orderBy('price','DESC')->get();
                return view('places.Multan',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'most-recent'){
                $cities=App\Models\Seller::where('city','=','Multan')->orderBy('created_at','DESC')->get();
                return view('places.Multan',compact('cities','filter'));
            }else{
                $cities=App\Models\Seller::where('city','=','Multan')->latest()->get();
            }
            $filter="most-recent";
            return view('places.Multan',compact('cities','filter'));})->name('Multan');
        ...
        Route::get('/Peshawar/{filter?}', function($filter = null){
            if (isset($filter) && $filter == 'lowest-price'){
                $cities=App\Models\Seller::where('city','=','Peshawar')->orderBy('price','asc')->get();
                return view('places.Peshawar',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'highest-price'){
                $cities=App\Models\Seller::where('city','=','Peshawar')->orderBy('price','DESC')->get();
                return view('places.Peshawar',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'most-recent'){
                $cities=App\Models\Seller::where('city','=','Peshawar')->orderBy('created_at','DESC')->get();
                return view('places.Peshawar',compact('cities','filter'));
            }else{
                $cities=App\Models\Seller::where('city','=','Peshawar')->latest()->get();
            }
            $filter="most-recent";
            return view('places.Peshawar',compact('cities','filter'));})->name('Peshawar');
        ...
        // Route::view('/Quetta', 'places.Quetta')->name('Quetta');
         ...
         Route::get('/Quetta/{filter?}', function($filter = null){
            if (isset($filter) && $filter == 'lowest-price'){
                $cities=App\Models\Seller::where('city','=','Quetta')->orderBy('price','asc')->get();
                return view('places.Quetta',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'highest-price'){
                $cities=App\Models\Seller::where('city','=','Quetta')->orderBy('price','DESC')->get();
                return view('places.Quetta',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'most-recent'){
                $cities=App\Models\Seller::where('city','=','Quetta')->orderBy('created_at','DESC')->get();
                return view('places.Quetta',compact('cities','filter'));
            }else{
                $cities=App\Models\Seller::where('city','=','Quetta')->latest()->get();
            }
            $filter="most-recent";
            return view('places.Quetta',compact('cities','filter'));})->name('Quetta');
        ...
        Route::get('/Sialkot/{filter?}', function($filter = null){
            if (isset($filter) && $filter == 'lowest-price'){
                $cities=App\Models\Seller::where('city','=','Sialkot')->orderBy('price','asc')->get();
                return view('places.Sialkot',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'highest-price'){
                $cities=App\Models\Seller::where('city','=','Sialkot')->orderBy('price','DESC')->get();
                return view('places.Sialkot',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'most-recent'){
                $cities=App\Models\Seller::where('city','=','Sialkot')->orderBy('created_at','DESC')->get();
                return view('places.Sialkot',compact('cities','filter'));
            }else{
                $cities=App\Models\Seller::where('city','=','Sialkot')->latest()->get();
            }
            $filter="most-recent";
            return view('places.Sialkot',compact('cities','filter'));})->name('Sialkot');
       ...
       Route::get('/Jhelum/{filter?}', function($filter = null){
            if (isset($filter) && $filter == 'lowest-price'){
                $cities=App\Models\Seller::where('city','=','Jhelum')->orderBy('price','asc')->get();
                return view('places.',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'highest-price'){
                $cities=App\Models\Seller::where('city','=','Jhelum')->orderBy('price','DESC')->get();
                return view('places.Jhelum',compact('cities','filter'));
            }elseif(isset($filter) && $filter == 'most-recent'){
                $cities=App\Models\Seller::where('city','=','Jhelum')->orderBy('created_at','DESC')->get();
                return view('places.Jhelum',compact('cities','filter'));
            }else{
                $cities=App\Models\Seller::where('city','=','Jhelum')->latest()->get();
            }
            $filter="most-recent";
            return view('places.Jhelum',compact('cities','filter'));})->name('Jhelum');
