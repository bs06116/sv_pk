...
<head>
    ...
    <title>ShinnyViewAdmin - @yield('title')</title>
...
<body class="fixed-left">
                ...
                <div class="user-details" style="padding: 8px;">
                    <div class="text-center">
                        <img src="{{ Auth::user()->image }}" alt="" class="rounded-circle"
                            style="height: 39px;width: 43px;">

                    </div>
                    <div class="user-info">
                        <a href="{{ route('profile') }}" style="color:#fff;font-size: 12px;">(Edit profile)</a>
                        <h4 class="font-16" style=" margin-top: 0px;">
                            {{ ucfirst(Auth::user()->name) }}({{ ucfirst(Auth::user()->type) }})</h4>
                        ...
                        @if (Auth::user()->type == 'admin')
                            ...
                            <li>
                                <a href="{{ route('seller.index') }}" class="waves-effect">
                                    <i class="fa fa-users" aria-hidden="true"></i>
                                    <span>View Private Sellers <span
                            ...
                            <li>
                              <a href="{{ route('application-from-request') }}" class="waves-effect">
                                  <i class="fa fa-building" aria-hidden="true"></i>
                                  <span>Application Form Request </span></a>
                              </li>
                            <br><br><br>
                            <hr style="width: 233px;height: -13px;background: aliceblue;">
                            <li>
                                <a href="#" class="waves-effect">
                                    ...
                                    <span> Phone
                                        :<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp{{ ucfirst(Auth::user()->number) }}</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="waves-effect">
                                    <i class="fa fa-envelope-o" aria-hidden="true"></i>
                                    <span> Email:<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                        {{ ucfirst(Auth::user()->email) }}</span>
                                </a>
                            </li>
                            <!--<li>-->
                            <!--  <a href="{{ url('/') }}" class="waves-effect">-->
                        ...
                        @elseif (Auth::user()->type=='agent')
                            ...
                            <li>
                                <a href="#" class="waves-effect infoTextss">
                                    ...
                                    <p class="sizeTextss" style="color: #83693b; text-align: center;display: none;">
                                        For main banner Advertisement Please contact with administrator</p>
                                </a>
                            </li>
                            <hr style="width: 233px;height: -13px;background: aliceblue;">
 ...
 padding: 10px 30px;
  ...
  color: white;
">Renew</button><br><br>
                            <p class="sizeTexts" style="color: #83693b; text-align: center;display: none;">For
                                Package Renewal Please contact with administrator</p>
...
">Upgrade Package</button>
                            <br><br>
                            <p class="sizeText" style="color: #83693b; text-align: center;display: none;">For
                                upgrade your Package Please contact with administrator</p>
                            <br><br><br><br><br><br>
                        ...
                        <ul class="list-inline float-right mb-0">
                            @if (Auth::user()->type == 'admin')
                                ...
                                <li class="list-inline-item dropdown notification-list">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                        ...
                                        <a class="dropdown-item" href="{{ url('contact') }}"><i
                                                class="mdi mdi-account-circle m-r-5 text-muted"></i> Support</a>
                            ...
                            @elseif (Auth::user()->type=='agent')
                                <li class="sellproperty">
                                    <span><a href="{{ route('addagentproperty') }}"><i class="fa fa-plus"
                                                aria-hidden="true"></i>&nbsp<b>Add Property</b></a></span>
                                </li>
                            ...
                            @elseif (Auth::user()->type=='seller')
                                <li class="sellproperty">
                                    <span><a href="{{ route('addproperty') }}"><i class="fa fa-plus"
                                                aria-hidden="true"></i>&nbsp<b>Add Property</b></a></span>
                                </li>
