...
@section('content')
        ...
        <div class="propertyHeader">
            <div class="aboutsale">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="ipt-title" style="color: aliceblue;">Sale Property List</h2>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 text-right">
                                    ...
                                    <select name="" id="filter_select" class="inputCommon">
                                        ...
                                        @endphp
                                            value="{{ route('property-sale', ['filter' => 'lowest-price']) }}">Lowest price
                                        </option>
                                        <option @php
                                        ...
                                        @endphp
                                            value="{{ route('property-sale', ['filter' => 'highest-price']) }}">Highest price
                                        </option>
                                        <option @php
                                        ...
                                        @endphp
                                            value="{{ route('property-sale', ['filter' => 'most-recent']) }}">Most Recent
                                        </option>
                                    </select>
                                </div>
                            </div>
                                    ...
                                    <div class="listCard">
                                        <div class="propertyImage">
                                            ...
                                            <span class="property-type"
                                                style="left: 250px;top: 13px;">{{ ucfirst($seller->type) }} </span>

                                            <span class="tag"
                                                style="position: absolute; position: absolute;right: 242px;top: 14px;color: #0f0f0f;padding: 4px 15px;border-radius: 50px;font-size: 12px;text-transform: uppercase;background: #1010108f;"><a
                                                    href=""> <i class="fa fa-camera" aria-hidden="true"
                                                        style="color: #f9f9fb;">&nbsp;&nbsp;<b>{{ $sum }}</b>
    ...
    ">
                                                    @if ($seller->bedroom != 0)
                                                        <li><strong><i class="fa fa-bed"
                                                                    aria-hidden="true"></i>&nbsp;</strong>
                                                            {{ ucfirst($seller->bedroom) }}</li>
                                                    @endif
                                                    @if ($seller->Bath != 0)
                                                        <li><strong><i class="fa fa-bath"
                                                                    aria-hidden="true"></i>&nbsp;</strong>
                                                            {{ ucfirst($seller->Bath) }}</li>
                                                    @endif
                                                    @if ($seller->size != 0)
                                                        <li><strong><i
                                                                    class="fa fa-arrows-alt text-muted mr-1"></i>&nbsp;{{ ucfirst($seller->size) }}</strong>&nbsp;&nbsp;{{ ucfirst($seller->area) }}
                                                        </li>
                                                    @endif
                                                </ul>
                                                <ul>
                                                    <span class="addReadMore showlesscontent"
                                                        style="margin-top: -26px; margin-bottom: 35px;">
                            ...
                            <form method="post" action="{{ route('search') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="input-with-icon">
                                        <input type="text" name="city" id="autocomplete-input" class="form-control"
                                            placeholder="City">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <div class="input-with-icon">
                                                <input type="text" name="maxnprice" id="maxprice" class="form-control"
                                                    placeholder="Max">
                                                <!--<i class="fa fa-usd"></i>-->
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="input-with-icon">
                                        ...
                                        <input type="text" name="bedroom" id="bedroom" class="form-control"
                                            placeholder="Bed Rooms"> <i class="fa fa-bed"></i>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-with-icon">
                                        <select name="purpose" class="form-control select2-hidden-accessible">
                                            {{-- <select id="ptypes"
                                                class="form-control select2-hidden-accessible" data-select2-id="ptypes"
                                ...
                                {{-- <div class="form-group">
                                    <div class="input-with-icon">
                                        <select id="cities" class="form-control select2-hidden-accessible"
                                            data-select2-id="cities" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <div class="input-with-icon">
                                                    <input type="text" name="minarea" id="minarea" class="form-control"
