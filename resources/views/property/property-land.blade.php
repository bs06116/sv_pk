        ...
        <div class="propertyHeader">
            <div class="aboutland">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="ipt-title" style="color: aliceblue;">Land Property List</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-8">
                        <div class="filterBox">
                            <div class="row">
                                <div class="col-lg-6">
                                    @php
                                    $count=App\Models\Seller::where('property','=','Plot')->count();
                                ...
                                <div class="col-lg-6 text-right">
                                    ...
                                    <select name="" id="filter_select" class="inputCommon">
                                        ...
                                        <option  @php if($filter=="lowest-price"){echo "selected"; } @endphp value="{{route('property-land',['filter'=>'lowest-price'])}}">Lowest price</option>
                                        <option @php if($filter=="highest-price"){echo "selected"; } @endphp  value="{{route('property-land',['filter'=>'highest-price'])}}">Highest price</option>
                                        <option @php if($filter=="most-recent"){echo "selected"; } @endphp   value="{{route('property-land',['filter'=>'most-recent'])}}">Most Recent</option>
                                    </select>
                                </div>
                            </div>
                        </div>
