        ...
        <div class="propertyHeader">
            <div class="aboutrent">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="ipt-title" style="color: aliceblue;">Rent Property List</h2>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 text-right">
                                    ...
                                    <select name="" id="filter_select" class="inputCommon">
                                        ...
                                        <option  @php if($filter=="lowest-price"){echo "selected"; } @endphp value="{{route('property-rent',['filter'=>'lowest-price'])}}">Lowest price</option>
                                        <option @php if($filter=="highest-price"){echo "selected"; } @endphp  value="{{route('property-rent',['filter'=>'highest-price'])}}">Highest price</option>
                                        <option   value="{{route('property-rent',['filter'=>'most-recent'])}}">Most Recent</option>
                                    </select>
                                </div>
                            </div>
                        </div>
