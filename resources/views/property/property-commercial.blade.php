        ...
        <div class="propertyHeader">
            <div class="aboutsale">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="ipt-title" style="color: aliceblue;">Commercial Property List</h2>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 text-right">
                                    ...
                                    <select name="" id="filter_select" class="inputCommon">
                                        ...
                                        <option @php if($filter=="most-recent"){echo "selected"; } @endphp   value="{{route('property-commercial',['filter'=>'most-recent'])}}">Most Recent</option>
                                    </select>
                                </div>
                            </div>
                        </div>
